...
export const metadata: Metadata = {
  title: "Simulateur Impôts Mariage et PACS 2026 - Calcul Couple Gratuit",
  description:
    "Calculez vos impôts avec le mariage ou le PACS en 2026 : imposition commune, quotient familial, économies réelles. Comparaison célibat vs union en 2 minutes. Gratuit et anonyme.",
  keywords: [
    "simulation impôts mariage",
    "calcul impôts mariage",
    "impôts PACS mariage",
    "quotient familial couple",
    "simulateur fiscal couple",
    "imposition commune",
    "économie impôts mariage",
    "déclaration commune 2026",
    "barème impôt 2026",
  ],
  alternates: {
  ...
  openGraph: {
    ...
    description: "Calculez vos impôts avec le mariage ou le PACS. Quotient familial, imposition commune, économies réelles. Simulation gratuite en 2 minutes.",
...
export default function Home() {
  return (
    <>
              ...
              <Card variant="outlined" className="hover:border-orange-300 transition-colors">
                <CardContent className="p-0 sm:p-0">
                  <h3 className="text-xl font-semibold text-stone-900 mb-3 flex items-center gap-2">
                    <svg aria-hidden="true" className="w-6 h-6 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Card variant="outlined" className="hover:border-orange-300 transition-colors">
                <CardContent className="p-0 sm:p-0">
                  <h3 className="text-lg sm:text-xl font-semibold text-stone-900 mb-2 sm:mb-3 flex items-center gap-2">
                    <svg aria-hidden="true" className="w-5 h-5 sm:w-6 sm:h-6 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <CardContent className="p-0 sm:p-0">
                  ...
                  <div className="mt-6 text-center">
                    <Link href="/quotient-familial" className="text-orange-600 hover:text-orange-700 font-medium">
                      <span aria-hidden="true">→ </span>Tout comprendre sur le quotient familial
                    </Link>
                  </div>
                </CardContent>
              </Card>
      ...
      {/* Section Mariage et Impôts - Signal SEO "mariage" */}
      <section className="py-10 sm:py-16 bg-white">
        <div className="container mx-auto px-3 sm:px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-bold text-stone-900 mb-6 sm:mb-8 text-center">
              Simulation impôts mariage : combien allez-vous économiser ?
            </h2>
            <div className="grid md:grid-cols-3 gap-4 sm:gap-6 mb-8">
              <div className="bg-orange-50 rounded-xl p-5 text-center">
                <div className="text-3xl font-bold text-orange-500 mb-1">2 parts</div>
                <div className="text-stone-700 font-medium mb-1">Quotient familial</div>
                <div className="text-stone-500 text-sm">de base pour tout couple marié ou pacsé</div>
              </div>
              <div className="bg-orange-50 rounded-xl p-5 text-center">
                <div className="text-3xl font-bold text-orange-500 mb-1">1 759 €</div>
                <div className="text-stone-700 font-medium mb-1">Par demi-part enfant</div>
                <div className="text-stone-500 text-sm">d&apos;avantage fiscal maximum en 2026</div>
              </div>
              <div className="bg-orange-50 rounded-xl p-5 text-center">
                <div className="text-3xl font-bold text-orange-500 mb-1">= 0 €</div>
                <div className="text-stone-700 font-medium mb-1">Droits de succession</div>
                <div className="text-stone-500 text-sm">entre époux mariés (avantage exclusif)</div>
              </div>
            </div>
            <div className="bg-stone-50 rounded-xl p-5 sm:p-6">
              <h3 className="font-semibold text-stone-900 mb-3">
                Mariage vs PACS : quelles différences pour vos impôts ?
              </h3>
              <p className="text-stone-600 text-sm sm:text-base mb-4">
                Sur l&apos;<strong>impôt sur le revenu</strong>, le mariage et le PACS offrent des avantages
                strictement identiques : imposition commune, même calcul du quotient familial,
                même barème progressif. Le mariage se démarque uniquement sur la <strong>succession</strong>
                (exonération totale) et la <strong>pension de réversion</strong>.
              </p>
              <Link href="/mariage" className="text-orange-600 hover:text-orange-700 font-medium inline-flex items-center gap-1 text-sm">
                Guide complet : mariage et impôts
                <svg aria-hidden="true" className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                </svg>
              </Link>
              ...
              <Link href="/pacs">
                <Card variant="outlined" className="hover:border-orange-300 transition-colors h-full p-4 md:p-4">
                  <CardContent className="p-3 sm:p-5 text-center">
                    <svg aria-hidden="true" className="w-6 h-6 sm:w-8 sm:h-8 mx-auto mb-2 sm:mb-3 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                    </svg>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-8 shadow-sm border border-stone-200">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-green-100 rounded-full flex items-center justify-center">
                  <svg aria-hidden="true" className="w-5 h-5 sm:w-6 sm:h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
