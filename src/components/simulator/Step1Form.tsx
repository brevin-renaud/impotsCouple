...
export function Step1Form({ register, errors }: Step1FormProps) {
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-stone-900 mb-2">
          Revenus du Conjoint A
        </h2>
      ...
      <Input
        ...
        hint="Salaires et traitements nets versés (ligne 1AJ sur la déclaration)"
      ...
      <Input
        ...
        type="number"
        placeholder="0"
        error={errors.fraisReelsA?.message}
        ...
        {...register('fraisReelsA', { setValueAs: (v) => v === '' || isNaN(v) ? undefined : Number(v) })}
      />
      ...
      <div className="pt-4 border-t border-stone-100">
        ...
        <Input
          ...
          type="number"
          placeholder="0"
          error={errors.pensionVerseeA?.message}
          ...
          {...register('pensionVerseeA', { setValueAs: (v) => v === '' || isNaN(v) ? undefined : Number(v) })}
        />
        ...
        <Input
          ...
          type="number"
          placeholder="0"
          error={errors.epargneRetraiteA?.message}
          ...
          {...register('epargneRetraiteA', { setValueAs: (v) => v === '' || isNaN(v) ? undefined : Number(v) })}
        />
        ...
        <Input
          ...
          type="number"
          placeholder="0"
          error={errors.patrimoineImmoA?.message}
          ...
          {...register('patrimoineImmoA', { setValueAs: (v) => v === '' || isNaN(v) ? undefined : Number(v) })}
        />
      </div>
    </div>
  )
